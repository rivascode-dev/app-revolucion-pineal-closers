...
**Objetivo:** Automatizar la mensajería post-firma.

1. **Servicio Webhook:** Configurar llamada POST al webhook de n8n tras la firma exitosa.
2. **Payload:** Enviar `nombre_cliente`, `telefono_cliente`, y `fechaActualizacion`.
3. **Manejo de Errores:** Evitar fallos bloqueantes en la UI si el webhook de n8n falla.
