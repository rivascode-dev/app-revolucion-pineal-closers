...
- [Material UI and Next.js](#materialui-and-nextjs)
  - [Abstract](#abstract)
  - [Table of contents](#table-of-contents)
  - [App Router (recommended)](#app-router-recommended)
    - [Dependencies](#dependencies)
    - [Root layout](#root-layout)
    - [Optional cache `options`](#optional-cache-options)
    - [URL hooks and Suspense](#url-hooks-and-suspense)
  - [Pages Router](#pages-router)
    - [Dependencies](#dependencies-1)
    - [`_document.tsx`](#_documenttsx)
    - [`_app.tsx`](#_apptsx)
    - [Optional: custom cache and cascade layers](#optional-custom-cache-and-cascade-layers)
    - [TypeScript](#typescript)
  - [Fonts (`next/font`)](#fonts-nextfont)
  - [CSS theme variables and SSR](#css-theme-variables-and-ssr)
  - [Other styling stacks (CSS layers)](#other-styling-stacks-css-layers)
  - [Next.js Link and `component` prop](#nextjs-link-and-component-prop)
